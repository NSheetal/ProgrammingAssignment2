...
# This function creates a special "matrix" object that can cache its inverse.It stores a martix and a cached value of the inverse of the matrix.
# It has thefollowing functions:
